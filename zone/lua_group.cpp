...
void Lua_Group::DisbandGroup(bool alt_msg) {
	Lua_Safe_Call_Void();
	self->DisbandGroup(alt_msg);
}

void Lua_Group::DisbandGroup(bool alt_msg, uint32 msg) {
	Lua_Safe_Call_Void();
	self->DisbandGroup(alt_msg, msg);
}
...
uint32 Lua_Group::GetTotalGroupDamage(Lua_NPC other) {
	Lua_Safe_Call_Int();
