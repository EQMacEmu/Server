...
bool Lua_EntityList::IsMobSpawnedByEntityID(int entityid) {
	Lua_Safe_Call_Bool();
	return self->IsMobSpawnedByEntityID(entityid);
}
...
bool Lua_EntityList::IsMobSpawnBySpawnID(uint32 id) {
	Lua_Safe_Call_Bool();
	return self->IsMobSpawnBySpawnID(id);
}
