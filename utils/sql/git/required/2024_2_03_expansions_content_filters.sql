...
-- spawnentry
ALTER TABLE `spawnentry` ADD `min_expansion` TINYINT(4) UNSIGNED NOT NULL DEFAULT '0';
ALTER TABLE `spawnentry` ADD `max_expansion` TINYINT(4) UNSIGNED NOT NULL DEFAULT '0';
