...
)
{
	...
	if (strcasecmp(args[0].c_str(), "world") == 0) {
		zoneserver_list.SendEmoteMessageRaw(0, 0, 0, atoi(args[1].c_str()), Strings::Join(join_args, " ").c_str());
	}
	else {
		ZoneServer* zs = zoneserver_list.FindByName(args[0].c_str());
		if (zs != 0) {
			zs->SendEmoteMessageRaw(0, 0, 0, atoi(args[1].c_str()), Strings::Join(join_args, " ").c_str());
		}
		else {
...
)
{
	...
	zoneserver_list.SendChannelMessage(tmpname, to.c_str(), 7, 0, 100, Strings::Join(join_args, " ").c_str());
}
...
)
{
	...
	tmpname[0] = '*';
	strcpy(&tmpname[1], connection->UserName().c_str());
	zoneserver_list.SendChannelMessage(tmpname, 0, 6, 0, 100, Strings::Join(args, " ").c_str());
}
...
)
{
	...
	tmpname[0] = '*';
	strcpy(&tmpname[1], connection->UserName().c_str());
	zoneserver_list.SendChannelMessage(tmpname, 0, 11, 0, 100, Strings::Join(args, " ").c_str());
}
...
)
{
	...
	tmpname[0] = '*';
	strcpy(&tmpname[1], connection->UserName().c_str());
	zoneserver_list.SendChannelMessage(tmpname, 0, 5, 0, 100, Strings::Join(args, " ").c_str());
}
...
)
{
	...
	tmpname[0] = '*';
	strcpy(&tmpname[1], connection->UserName().c_str());
	zoneserver_list.SendChannelMessage(tmpname, 0, 4, 0, 100, Strings::Join(args, " ").c_str());
}
