...
public:
     ...
     *
     * PlayerEventMerchantPurchaseRepository::GetByZoneAndVersion(int zone_id, int zone_version)
     * PlayerEventMerchantPurchaseRepository::GetWhereNeverExpires()
     * PlayerEventMerchantPurchaseRepository::GetWhereXAndY()
     * PlayerEventMerchantPurchaseRepository::DeleteWhereXAndY()
     *
