...
{
	m_process_batch_events_timer.Start(RuleI(Logging, BatchPlayerEventProcessIntervalSeconds) * 1000);
	m_process_retention_truncation_timer.Start(PROCESS_RETENTION_TRUNCATION_TIMER_INTERVAL);
	m_database_ping_timer.Start(10 * 1000); // 10 seconds
