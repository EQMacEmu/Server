...
#ifndef WIN32
	Log(Logs::Detail, Logs::TCPConnection, "%s Starting TCPConnectionLoop with thread ID %d", __FUNCTION__, pthread_self());
#endif
...
#ifndef WIN32
	Log(Logs::Detail, Logs::TCPConnection, "%s Ending TCPConnectionLoop with thread ID %d", __FUNCTION__, pthread_self());
#endif
